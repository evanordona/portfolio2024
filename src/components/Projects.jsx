        ...
        <div name='projects' className='w-screen font-heading bg-background pt-[15rem]'>
            ...
            <div className='flex flex-col items-center justify-center'>
                ...
                <div className='grid-cols-3 mx-auto mt-10 lg:grid'>
                    ...
                    <Project className={"border-2 border-primary mb-5"} title={"Lords Duel"} description={"Built a multiplayer card game with React, Socket.io, Express, and Tailwind."} img={mak} gitLink={"https://github.com/evanordona/mak_multi"} demoLink={"https://www.lordsduel.com/"} />
